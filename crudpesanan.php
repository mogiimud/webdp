...
<body>
    ...
    <table border="1" class="table">
        ...
        $query_mysql = mysqli_query($mysqli, "SELECT * FROM orders") or die(mysqli_error($mysqli));
        $nomor = 1;
        while ($data = mysqli_fetch_array($query_mysql)) {
            ...
            echo "<td><a href='deleteorder.php?id=".$data["id"]."'>Hapus</a></td>";
            echo "<td><a href='edit_order.php?id=".$data["id"]."'>Edit</a></td>";
            echo "</tr>";
        }
        ?>
    </table>
